...
async function loadChannels() {
  ...
  try {
    ...
    // Auto load last played channel (disabled — Telegram Android WebView
    // এ HLS auto-attach native fullscreen player trigger করত)
    loadLastChannel();
  } catch (err) {
    console.error(err);
    channelList.innerHTML = `
...
function loadLastChannel() {
  // FIX: app খোলার সাথে সাথে HLS media attach বন্ধ — ইউজার ট্যাপ করলে
  // তবেই video attach/play হবে।
  return;
}
